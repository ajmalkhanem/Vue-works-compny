<template>
    <div>
      ...
      <input type="text" class="form-control" v-model="users1.amount" style="background-color: rgb(233, 238, 240);" placeholder="Amount" >
           ...
           <div class="form-group">
      <label for="policy" style="color: cadetblue;"><b>Fuel Station:</b></label>
