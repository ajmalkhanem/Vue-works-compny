    ...
    <div class="container" >
      <div class="row">
        ...
        <div class="col-md-6" style="padding-top:10px!important;padding-bottom:50px!important;">
          <div 
            style="padding-left:20px!important;height: 500px; padding-right:20px!important;text-align: center;background-color:white;border:solid rgb(235, 238, 240) 2px;float:left;margin-top:20px;margin-left:20px;">
            <br><br><br>

            <h2 style="color:#03adfc;">Reset Password</h2><br>

            <p style="font-size: 14px">Please enter your email address and we'll send you a <br>link to reset your password</p>
            <br>
            <br>
            <form @submit.prevent="submit1" style="padding-bottom:30px!important;">
                <div class="row">
                    ...
                    <div class="col-md-8">
                            <div class="form-group">
                                    ...
                                    <input type="text" style="width:100%;background-color: rgb(233, 238, 240);text-align: center;"
                                    required class="form-control " id="rcorners1" aria-describedby="emailHelp" placeholder="Enter Email Address">
              ...
              <b-row>
                  ...
                  <b-col>
                                ...
                                <label style="color:#03adfc;">Back to Sign in</label>
